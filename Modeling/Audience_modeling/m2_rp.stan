//The RW model using diff LR for pos. and neg. outcomes
...
// Declare all parameters as vectors for vectorizing
  ...
  vector[3] mu_pr; //mean of the parameters,3 paras (2 learning rates and inverse temperature)
  vector<lower=0>[3] sigma; //variance of the parameters, 2 paras
