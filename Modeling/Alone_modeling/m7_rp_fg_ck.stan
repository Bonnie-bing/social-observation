...
// Declare all parameters as vectors for vectorizing
  ...
  vector[6] mu_pr; //mean of the parameters,6 paras (2 learning rates and inverse temperature) + (1 LR and it for CK) + forget para
  vector<lower=0>[6] sigma; //variance of the parameters, 2 paras
...
transformed parameters {
  ...
  for (i in 1:Ns) {
    ...
    fp[i]        = Phi_approx(mu_pr[6] + sigma[6] * fp_pr[i]);
  }
