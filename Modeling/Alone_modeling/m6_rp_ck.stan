// The combined model: Reward/punishment model + choice kernel model
...
// Declare all parameters as vectors for vectorizing
  ...
  vector[5] mu_pr; //mean of the parameters,5 paras (2 learning rates and inverse temperature) + (1 LR and it for CK)
  ...
  vector[Ns] etack_pr;  // etar: learning rate for ck
  vector[Ns] tauck_pr;    // tau: Inverse temperature for ck
}
